...
public class AplicacaoRepositorioUsuario {
	public static void main(String[] args) {
		...
		Usuario novo = new Usuario("user","netogiuseppe@hotmail.com","recife97","(81) 9 8770-4889",
				"Giuseppe","Fiorentino Neto","26/01/1997","Masculino");
		Usuario novonovo = new Usuario("user","morteaosmachistas@hotmail.com","morteaosmachistas","(11) 9 86690-6660",
		...
		//testeamigos
		Amigo novoamigo= new Amigo("user");
		novoamigo.setNome(novonovo.getNome());
		novoamigo.setEmail(novonovo.getEmail());
		
		System.out.println(novo.getRepAmigos().add(novoamigo));
		System.out.println(novo.getRepAmigos().remove(novoamigo));
